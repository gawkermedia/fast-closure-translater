...
var _ = require('underscore'),
	...
	readTranslationFile = require('./lib/translation-parser'),
...
function buildI18n(fileContents, translations, defaultLocale, replacementRegex) {
	...
	function getGoogMsgArguments(syntaxTree) {
		var templateArgumentsObject;
		if (syntaxTree.body[0].expression) {
			templateArgumentsObject = syntaxTree.body[0].expression.arguments[1];  // jshint ignore:line
